...
func convertGaiaFromPixelsRowToMetadata(r repository.GetGaiaFromPixelsRow) repository.Metadata {
	return repository.Metadata{
		...
		Object: repository.Gaia{
			...
			DecError:                  r.DecError,
			Parallax:                  r.Parallax,
			ParallaxError:             r.ParallaxError,
			Pm:                        r.Pm,
			Pmra:                      r.Pmra,
			PmraError:                 r.PmraError,
			Pmdec:                     r.Pmdec,
			PmdecError:                r.PmdecError,
			AstrometricExcessNoise:    r.AstrometricExcessNoise,
			AstrometricExcessNoiseSig: r.AstrometricExcessNoiseSig,
			Ruwe:                      r.Ruwe,
			PhotGNObs:                 r.PhotGNObs,
			PhotGMeanFlux:             r.PhotGMeanFlux,
			PhotGMeanFluxError:        r.PhotGMeanFluxError,
			PhotGMeanFluxOverError:    r.PhotGMeanFluxOverError,
			PhotGMeanMag:              r.PhotGMeanMag,
			PhotBpNObs:                r.PhotBpNObs,
			PhotBpMeanFlux:            r.PhotBpMeanFlux,
			PhotBpMeanFluxError:       r.PhotBpMeanFluxError,
			PhotBpMeanFluxOverError:   r.PhotBpMeanFluxOverError,
			PhotBpMeanMag:             r.PhotBpMeanMag,
			PhotRpNObs:                r.PhotRpNObs,
			PhotRpMeanFlux:            r.PhotRpMeanFlux,
			PhotRpMeanFluxError:       r.PhotRpMeanFluxError,
			PhotRpMeanFluxOverError:   r.PhotRpMeanFluxOverError,
			PhotRpMeanMag:             r.PhotRpMeanMag,
			PhotBpRpExcessFactor:      r.PhotBpRpExcessFactor,
			PhotProcMode:              r.PhotProcMode,
			BpRp:                      r.BpRp,
			BpG:                       r.BpG,
			GRp:                       r.GRp,
			RadialVelocity:            r.RadialVelocity,
			RadialVelocityError:       r.RadialVelocityError,
			RvMethodUsed:              r.RvMethodUsed,
			PhotVariableFlag:          r.PhotVariableFlag,
			InQsoCandidates:           r.InQsoCandidates,
			InGalaxyCandidates:        r.InGalaxyCandidates,
			NonSingleStar:             r.NonSingleStar,
			HasEpochPhotometry:        r.HasEpochPhotometry,
			ClassprobDscCombmodQuasar: r.ClassprobDscCombmodQuasar,
			ClassprobDscCombmodGalaxy: r.ClassprobDscCombmodGalaxy,
			ClassprobDscCombmodStar:   r.ClassprobDscCombmodStar,
			TeffGspphot:               r.TeffGspphot,
			TeffGspphotLower:          r.TeffGspphotLower,
			TeffGspphotUpper:          r.TeffGspphotUpper,
			LoggGspphot:               r.LoggGspphot,
			LoggGspphotLower:          r.LoggGspphotLower,
			LoggGspphotUpper:          r.LoggGspphotUpper,
			MhGspphot:                 r.MhGspphot,
			MhGspphotLower:            r.MhGspphotLower,
			MhGspphotUpper:            r.MhGspphotUpper,
			DistanceGspphot:           r.DistanceGspphot,
			DistanceGspphotLower:      r.DistanceGspphotLower,
			DistanceGspphotUpper:      r.DistanceGspphotUpper,
		},
	}
}
...
func (a Adapter) ConvertToMetadataFromRaw(raw any) (any, error) {
	...
	return repository.Gaia{
		ID:                        schema.Designation,
		SourceID:                  repository.NullInt64{sql.NullInt64{Int64: schema.SourceID, Valid: true}},
		RaError:                   repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.RAError), Valid: true}},
		DecError:                  repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.DecError), Valid: true}},
		Parallax:                  repository.NullFloat64{sql.NullFloat64{Float64: schema.Parallax, Valid: true}},
		ParallaxError:             repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.ParallaxError), Valid: true}},
		Pm:                        repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PM), Valid: true}},
		Pmra:                      repository.NullFloat64{sql.NullFloat64{Float64: schema.PMRA, Valid: true}},
		PmraError:                 repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PMRAError), Valid: true}},
		Pmdec:                     repository.NullFloat64{sql.NullFloat64{Float64: schema.PMDec, Valid: true}},
		PmdecError:                repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PMDecError), Valid: true}},
		AstrometricExcessNoise:    repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.AstrometricExcessNoise), Valid: true}},
		AstrometricExcessNoiseSig: repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.AstrometricExcessNoiseSig), Valid: true}},
		Ruwe:                      repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.Ruwe), Valid: true}},
		PhotGNObs:                 repository.NullInt64{sql.NullInt64{Int64: int64(schema.PhotGNObs), Valid: true}},
		...
		PhotGMeanFluxOverError:    repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotGMeanFluxOverError), Valid: true}},
		PhotGMeanMag:              repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotGMeanMag), Valid: true}},
		PhotBpNObs:                repository.NullInt64{sql.NullInt64{Int64: int64(schema.PhotBpNObs), Valid: true}},
		...
		PhotBpMeanFluxOverError:   repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotBpMeanFluxOverError), Valid: true}},
		PhotBpMeanMag:             repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotBpMeanMag), Valid: true}},
		PhotRpNObs:                repository.NullInt64{sql.NullInt64{Int64: int64(schema.PhotRpNObs), Valid: true}},
		...
		PhotRpMeanFluxOverError:   repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotRpMeanFluxOverError), Valid: true}},
		PhotRpMeanMag:             repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotRpMeanMag), Valid: true}},
		PhotBpRpExcessFactor:      repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.PhotBpRpExcessFactor), Valid: true}},
		PhotProcMode:              repository.NullInt64{sql.NullInt64{Int64: int64(schema.PhotProcMode), Valid: true}},
		BpRp:                      repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.BpRp), Valid: true}},
		BpG:                       repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.BpG), Valid: true}},
		GRp:                       repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.GRp), Valid: true}},
		RadialVelocity:            repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.RadialVelocity), Valid: true}},
		RadialVelocityError:       repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.RadialVelocityError), Valid: true}},
		RvMethodUsed:              repository.NullInt64{sql.NullInt64{Int64: int64(schema.RvMethodUsed), Valid: true}},
		PhotVariableFlag:          repository.NullString{sql.NullString{String: schema.PhotVariableFlag, Valid: true}},
		InQsoCandidates:           repository.NullInt64{sql.NullInt64{Int64: boolToInt64(schema.InQsoCandidates), Valid: true}},
		InGalaxyCandidates:        repository.NullInt64{sql.NullInt64{Int64: boolToInt64(schema.InGalaxyCandidates), Valid: true}},
		NonSingleStar:             repository.NullInt64{sql.NullInt64{Int64: int64(schema.NonSingleStar), Valid: true}},
		HasEpochPhotometry:        repository.NullInt64{sql.NullInt64{Int64: boolToInt64(schema.HasEpochPhotometry), Valid: true}},
		ClassprobDscCombmodQuasar: repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.ClassprobDscCombmodQuasar), Valid: true}},
		ClassprobDscCombmodGalaxy: repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.ClassprobDscCombmodGalaxy), Valid: true}},
		ClassprobDscCombmodStar:   repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.ClassprobDscCombmodStar), Valid: true}},
		TeffGspphot:               repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.TeffGspphot), Valid: true}},
		TeffGspphotLower:          repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.TeffGspphotLower), Valid: true}},
		TeffGspphotUpper:          repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.TeffGspphotUpper), Valid: true}},
		LoggGspphot:               repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.LoggGspphot), Valid: true}},
		LoggGspphotLower:          repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.LoggGspphotLower), Valid: true}},
		LoggGspphotUpper:          repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.LoggGspphotUpper), Valid: true}},
		MhGspphot:                 repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.MhGspphot), Valid: true}},
		MhGspphotLower:            repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.MhGspphotLower), Valid: true}},
		MhGspphotUpper:            repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.MhGspphotUpper), Valid: true}},
		DistanceGspphot:           repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.DistanceGspphot), Valid: true}},
		DistanceGspphotLower:      repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.DistanceGspphotLower), Valid: true}},
		DistanceGspphotUpper:      repository.NullFloat64{sql.NullFloat64{Float64: float64(schema.DistanceGspphotUpper), Valid: true}},
	}, nil
}
